...
for t in range(run_times):
    ...
    optimizer = EWOA(fitness=benchmark.Sphere,
    ...
    optimizer = EWOA(fitness=benchmark.Rastrigin,
    ...
    optimizer = EWOA(fitness=benchmark.Ackley,
    ...
    optimizer = EWOA(fitness=benchmark.Griewank,
    ...
    optimizer = EWOA(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = EWOA(fitness=benchmark.Rosenbrock,
    ...
    optimizer = EWOA(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = EWOA(fitness=benchmark.Quartic,
    ...
    optimizer = EWOA(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = EWOA(fitness=benchmark.Penalized1,
    ...
    optimizer = EWOA(fitness=benchmark.Penalized2,
    ...
    optimizer = EWOA(fitness=benchmark.Schwefel_226,
    ...
    optimizer = EWOA(fitness=benchmark.Step,
    ...
    optimizer = EWOA(fitness=benchmark.Kowalik,
    ...
    optimizer = EWOA(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = EWOA(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = EWOA(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = EWOA(fitness=Shekel7,
                     D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = EWOA(fitness=benchmark.Shekel,
                     D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = EWOA(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = EWOA(fitness=benchmark.Hartmann6,
    ...
    optimizer = EWOA(fitness=benchmark.Zakharov,
    ...
    optimizer = EWOA(fitness=benchmark.SumSquares,
    ...
    optimizer = EWOA(fitness=benchmark.Alpine,
    ...
    optimizer = EWOA(fitness=benchmark.Michalewicz,
    ...
    optimizer = EWOA(fitness=benchmark.Exponential,
    ...
    optimizer = EWOA(fitness=benchmark.Schaffer,
    ...
    optimizer = EWOA(fitness=benchmark.BentCigar,
    ...
    optimizer = EWOA(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = EWOA(fitness=benchmark.Elliptic,
    ...
    optimizer = EWOA(fitness=benchmark.DropWave,
    ...
    optimizer = EWOA(fitness=benchmark.CosineMixture,
    ...
    optimizer = EWOA(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = EWOA(fitness=benchmark.LevyandMontalvo1,
...
loss_curves.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                       ...
                       'Levy and Montalvo 1']
loss_curves.to_csv('loss_curves(EWOA).csv')
